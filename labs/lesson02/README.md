...
#### Тест подключения
Попингуем себя... Удачно!

![](img/2026-05-27_21-42-48.png)

Проверим доступность коммутатора... Удачно!

![](img/2026-05-27_21-43-32.png)

#### Удалённое подключение Telnet
IP связанность есть, пробуем подключиться к коммутатору по протоколу telnet и пробуем выполнить указанные действия.

![](img/2026-05-27_21-48-42.png)

Подключение прошло успешно, коммутатор спросил нас заданный пароль и в при подключении и при переходе в привилегированный режим. Сохранили конфигурацию и вышли командой `exit`.

> **Q: Зачем необходимо настраивать пароль VTY для коммутатора?**
> 
> **A:** Для ограничения доступа посторонних лиц к конфигурации коммутатора.

> **Q: Что нужно сделать, чтобы пароли не отправлялись в незашифрованном виде?**
> 
> **A:** Использовать зашифрованный протокол SSH.